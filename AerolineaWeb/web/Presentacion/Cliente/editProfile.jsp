                ...
                <div class="col-lg-4 ">
                    <p class="h1">Perfil Cliente</p><br><br>
                     <form name="form_registro" id="form_registro" onsubmit="return validarRegistroCliente();" action="ControladorWCliente" >
                        ...
                        <div class="row">
                            <div class="col">
                                <input class="form-control" type="email" name="emailCorreo"  placeholder="Correo electrónico" id="correo" value="<%=cliente.getCorreo()%>">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col">
                                <input class="form-control" type="text" name="txtDireccion" placeholder="Dirección" id="direccion" value="<%=cliente.getDireccion()%>">
                            </div> 
                        </div>
                        <br>
                        <div class="row">
                            <div class="col">
                                <input class="form-control" type="tel" name="telTelefono" placeholder="Teléfono" id="telefono" value="<%=cliente.getTelefono()%>">
                            </div>
                            <div class="col">
